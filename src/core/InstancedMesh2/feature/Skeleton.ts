...
export function initSkeleton(this: InstancedMesh2, skeleton: Skeleton, disableMatrixAutoUpdate = true): void {
...
export function setBonesAt(this: InstancedMesh2, id: number, updateBonesMatrices = true, excludeBonesSet?: Set<string>): void {
...
function multiplyBoneMatricesAt(target: InstancedMesh2, instanceIndex: number, boneIndex: number, m1: Matrix4, m2: Matrix4): void {
    const offset = (instanceIndex * target.skeleton.bones.length + boneIndex) * 16;
