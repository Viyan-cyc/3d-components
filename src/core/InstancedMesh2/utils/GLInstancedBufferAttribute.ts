import { GLBufferAttribute, type TypedArray, type WebGLRenderer } from 'three';
...
export class GLInstancedBufferAttribute extends GLBufferAttribute {
  ...
  // eslint-disable-next-line max-params -- mirrors GLBufferAttribute parent API; caller uses positional args
  constructor(
